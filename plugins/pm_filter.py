...
async def next_page(bot, query):
    ...
    if int(req) not in [query.from_user.id, 0]:
        ...
        return await query.answer("Type New Msg", show_alert=True)
...
try:
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🤖 Bot Father', url='https://t.me/RoyalKrrishna')
...
async def advantage_spell_chok(msg):
    ...
    if not g_s:
        ...
        k = await msg.reply("<b>I Couldn't Find Any Movie Of This Name.</b>")
